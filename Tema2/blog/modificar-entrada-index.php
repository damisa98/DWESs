    ...
    if(isset($_SESSION['errores'])){
        ...
        ?>
            ...
            <div class="form-group">
                <form action="modificar-entrada.php" method="post">
                    <label for="titulo">Titulo</label>
                    <input type="text" name="titulo" id="titulo" value="<?= $fila['titulo'] ?> "required><br>
                    <label for="descripcion">descripcion</label>
                    <input type="text" name="descripcion" id="descripcion" value="<?= $fila['descripcion'] ?>"required><br>
                    ...
                    <?php 
                        while ($cate=mysqli_fetch_assoc($resul)) {?>
