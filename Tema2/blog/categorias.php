...
<body>
    ...
    if(isset($_SESSION['errores'])){
        ...
        <?php
            ...
            $entradas="SELECT entradas.id,entradas.titulo,entradas.descripcion,entradas.fecha,categorias.nombre FROM categorias INNER JOIN entradas on(categorias.id=entradas.categoria_id) WHERE categorias.id=$idCategoria ";
        ...
        ?>
            <div class="ultimaEntrada">
                <h3><?= $fila['titulo'] ?> <?= $fila['nombre'] ?><a href="borrar-entrada.php?id=<?= $fila['id'] ?>"><img src="img/papelera.png" alt="Borrar"></a><a href="modificar-entrada-index.php?id=<?= $fila['id'] ?>"><img src="img/lapiz.png" alt="Modificar"></a></h3>
